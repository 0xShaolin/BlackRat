...
const wineExecutable = new (_electronBuilderUtil || _load_electronBuilderUtil()).Lazy((0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
    (0, (_electronBuilderUtil || _load_electronBuilderUtil()).debug)(`USE_SYSTEM_WINE: ${process.env.USE_SYSTEM_WINE}`);
    if (!(0, (_flags || _load_flags()).isUseSystemWine)() && (yield (0, (_macosVersion || _load_macosVersion()).isMacOsSierra)())) {
