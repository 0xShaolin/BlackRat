...
const knownAlwaysIgnoredDevDeps = new Set(["electron-builder", "electron-builder-tslint-config", "electron-builder-util", "electron-publish", "electron-download-tf", "electron-download", "electron-forge", "electron-packager", "electron-compilers", "jest", "jest-cli", "prebuild-install", "nan", "asar-integrity", "asar", "electron-webpack", "electron-webpack-ts", "electron-webpack-vue", "react-scripts"]);
function createLazyProductionDeps(projectDir) {
    return new (_electronBuilderUtil || _load_electronBuilderUtil()).Lazy(() => getProductionDependencies(projectDir));
}
