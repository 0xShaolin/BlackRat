        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            if (_this.isPublish) {
                for (const publishConfig of publishConfigs) {
                    ...
                    if (eventFile == null) {
                        _this.taskManager.addTask(publisher.uploadData(event.data, event.safeArtifactName));
                    } else {
                        _this.taskManager.addTask(publisher.upload(eventFile, event.safeArtifactName));
                    }
                }
            }
