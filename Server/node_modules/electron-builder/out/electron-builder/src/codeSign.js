    ...
    var _ref3 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (_ref4) {
        ...
        if (!(list.indexOf(keychainFile) !== -1)) {
            ...
            if (!(_isCi || _load_isCi()).default) {
                ...
                process.once("beforeExit", (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
                    try {
                        const list = (yield listUserKeychains()).filter(function (it) {
                            return it != keychainFile;
                        });
                        (0, (_electronBuilderUtil || _load_electronBuilderUtil()).exec)("security", ["list-keychains", "-d", "user", "-s"].concat(list));
                    } catch (e) {
                        (0, (_log || _load_log()).warn)(`Cannot restore keychain search list: ${e}`);
                    }
                }));
            }
        }
...
function _load_log() {
    return _log = require("../../electron-builder-util/src/log");
}
