...
let readChildPackage = (() => {
    var _ref4 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (name, parentDir, parent, parentDepth, pathToMetadata) {
        ...
        if (isSymbolicLink) {
            ...
            if (dir == null) {
                (0, (_electronBuilderUtil || _load_electronBuilderUtil()).debug)(`Broken symlink ${dir}`);
                return null;
            }
        }
    ...
    var _ref5 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (dir) {
        ...
        try {
            files = (yield (0, (_fsExtraP || _load_fsExtraP()).readdir)(dir)).filter(function (it) {
                return !it.startsWith(".") && it !== "prebuild-install" && it !== "nan" && it !== "node-pre-gyp";
            });
        } catch (e) {
        ...
        const scopes = files.filter(function (it) {
            return it.startsWith("@") && !it.startsWith("@types");
        });
        if (scopes.length === 0) {
            return files;
        }
