...
exports.AppFileWalker = exports.AppFileCopierHelper = undefined;
...
class AppFileCopierHelper {
    ...
    collect(fileWalker) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            const files = yield (0, (_fs || _load_fs()).walk)(fileWalker.src, fileWalker.filter, fileWalker);
...
exports.AppFileCopierHelper = AppFileCopierHelper; /** @internal */

class AppFileWalker {
    constructor(src, packager, filter) {
        this.src = src;
    ...
    handleSymlink(fileStat, file, linkTarget) {
        const link = _path.relative(this.src, linkTarget);
        if (link.startsWith("..")) {
    ...
    copyNodeModules(list, filter, consumer) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            for (const dep of list) {
                ...
                queue[0] = dep.path;
                if (dep.link != null) {
                    _this2.metadata.set(dep.path, dep.stat);
                    const r = _this2.handleSymlink(dep.stat, dep.path, dep.link);
                    if (r != null) {
                        yield r;
                    }
                }
