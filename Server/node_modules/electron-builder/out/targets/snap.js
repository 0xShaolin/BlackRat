...
class SnapTarget extends (_core || _load_core()).Target {
    ...
    build(appOutDir, arch) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            (0, (_electronBuilderUtil || _load_electronBuilderUtil()).log)(`Building Snap for arch ${(_core || _load_core()).Arch[arch]}`);
            ...
            if (isUseDocker) {
                ...
                commands.push("cd /s");
                commands.push(`snapcraft snap --target-arch ${(0, (_core || _load_core()).toLinuxArchString)(arch)} -o /out/${snapFileName}`);
